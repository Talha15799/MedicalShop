...
{
    public partial class PurchasedwForm : Form
    {
        public PurchasedwForm()
        {
            InitializeComponent();
        }
        ...
        private void PurchasedwForm_Load(object sender, EventArgs e)
        {
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            {
                objad = new SqlDataAdapter("select * from purchase where dos>='" + DTPfrom.Text+ "' and dos<='" + DTPto.Text + "'", objcon);
                objdt = new DataTable();
                objad.Fill(objdt);
